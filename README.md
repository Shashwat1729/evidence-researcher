...
<table>
<tr>
<td><img src="docs/screenshots/overview.png" alt="Harappan Standard — overview with 30 sources, 12 claims" width="100%"><br><em>Standard — Harappan overview (30 sources → 12 claims → 14 findings)</em></td>
<td><img src="docs/screenshots/report.png" alt="Final report — 14 findings, cold-open story" width="100%"><br><em>Final report — 14 findings, cold-open story (book-chapter, ~30k chars)</em></td>
</tr>
<tr>
...
```bash
npm test        # 230 tests: units + offline full-pipeline E2E (16/16 audit) + HTTP/SSE
...
tests/                 230 offline tests (no key/network required)
